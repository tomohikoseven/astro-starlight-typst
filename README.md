...
- **Fletcher による高度な図式描画**: 可換図式やフローチャート、状態遷移図を数式モード感覚で美しく直感的に描画できる **Fletcher 0.5.9** を追加サポート。
...
- **CeTZ (libs/cetz)**: ベクターグラフィックス描画ライブラリ。
- **Fletcher (libs/fletcher)**: 高機能ダイアグラム・可換図式描画ライブラリ（CeTZベース）。
